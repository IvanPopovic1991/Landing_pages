...
public class RegistrationTestLp8 extends BaseTest {
    @BeforeMethod
    public void setUp() {
        baseSetUp("OPERA", "114");
    ...
    @Test(description = "User register account successfully on www.fortrade.com/minilps/en/fast-execution/ page")
    ...
    public void accountRegistrationFullName(String countryCodeNumber, String regulative) throws IOException {
        ...
        accountRegistrationFullNamePage.accountRegistrationFullNamePageMethod("Testq Testa",
                "testqpyjQgJ"+System.currentTimeMillis()+"@mailinator.com",""+countryCodeNumber,
    ...
    public void checkTermsAndConditionsLinkRedirection(String regulation, String tag) throws IOException, InterruptedException {
        ...
        driver.get("https://www.fortrade.com/minilps/en/fast-execution/" + tag + "");
        AccountRegistrationFullNamePage accountRegistrationFullNamePage = new AccountRegistrationFullNamePage(driver);
        WebDriverWait wdWait = new WebDriverWait(driver, 10);
    ...
    public void checkRiskWarningLinkRedirection(String regulation, String tag) throws IOException {
        ...
        wdWait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//div[@id='formWrapper' and @class='col" +
                "-md-5 formCover formCoverFixed']//button[@onclick='myCloseFormFunction()']")));
        wdWait.until(ExpectedConditions.elementToBeClickable(By.xpath("//div[@id='formWrapper' and @class='col-md" +
                "-5 formCover formCoverFixed']//button[@onclick='myCloseFormFunction()']")));
        accountRegistrationFullNamePage.clickElement(accountRegistrationFullNamePage.closeBtn, "close button in footer");
    ...
    public void checkFSCLinkRedirection(String regulation) throws IOException, InterruptedException {
        ...
        JavascriptExecutor js = (JavascriptExecutor) driver;
        js.executeScript("window.scroll(0,document.body.scrollHeight)");
        wdWait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//div[@id='formWrapper']//button" +
                "[@onclick='myCloseFormFunction()']")));
        wdWait.until(ExpectedConditions.elementToBeClickable(By.xpath("//div[@id='formWrapper']//button" +
                "[@onclick='myCloseFormFunction()']")));
        accountRegistrationFullNamePage.clickCloseBtn();
