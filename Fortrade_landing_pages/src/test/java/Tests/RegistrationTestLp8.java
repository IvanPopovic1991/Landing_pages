...
public class RegistrationTestLp8 extends BaseTest {
    ...
    @Test(description = "User register account successfully on www.fortrade.com/minilps/en/no-commission/ page")
    ...
    public void accountRegistration(String countryCodeNumber, String regulative) throws IOException {
        driver.get("https://www.fortrade.com/minilps/en/no-commission/");
