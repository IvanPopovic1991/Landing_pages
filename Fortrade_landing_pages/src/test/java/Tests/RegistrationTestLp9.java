...
public class RegistrationTestLp9 extends BaseTest {
    ...
    @Test(description = "User register account successfully on www.fortrade.com/minilps/en/reg-place-stocks-in-your-" +
            "future/ page")
    ...
    public void checkTermsAndConditionsLinkRedirection(String regulation, String tag) throws IOException, InterruptedException {
        ...
        driver.get("https://www.fortrade.com/minilps/en/reg-place-stocks-in-your-future/" + tag + "");
        AccountRegistrationPage accountRegistrationPage = new AccountRegistrationPage(driver);
        WebDriverWait wdWait = new WebDriverWait(driver, 10);
