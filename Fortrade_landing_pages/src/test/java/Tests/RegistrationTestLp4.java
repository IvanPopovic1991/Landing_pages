...
public class RegistrationTestLp4 extends BaseTest {
    @BeforeMethod
    public void setUp() {
        baseSetUp("OPERA", "114");
    ...
    @Test(description = "User register account successfully on - www.fortrade.com/minilps/en/cryptocurrency/")
    ...
    public void checkTermsAndConditionsLinkRedirection(String regulation, String tag) throws IOException, InterruptedException {
        ...
        driver.get("https://www.fortrade.com/minilps/en/cryptocurrency/" + tag + "");
        AccountRegistrationPage accountRegistrationPage = new AccountRegistrationPage(driver);
        ...
        actions.moveToElement(termsAndConditionsLink).perform();
