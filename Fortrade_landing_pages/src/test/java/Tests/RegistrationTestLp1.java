...
public class RegistrationTestLp1 extends BaseTest {
    ...
    @Test(description = "User register account successfully on www.fortrade.com/minilps/en/reg-to-invest-in-stocks-only-work-wi" +
            "th-the-best/ page")
    @Description("User register account successfully under certain regulation")
    @Parameters({"countryCodeNumber", "regulative"})
    public void accountRegistration(String countryCodeNumber, String regulative) throws IOException, InterruptedException {
    ...
    public void checkFieldsValidation() throws IOException {
        AccountRegistrationPage accountRegistrationPage = new AccountRegistrationPage(driver);
        accountRegistrationPage.clickElement(accountRegistrationPage.startNowBtn, "send button");
        WebDriverWait wait = new WebDriverWait(driver, 10);
        wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//div[@class='errorValidationIn' and te" +
                "xt()='Please enter all your given first name(s)']")));
        wait.until(ExpectedConditions.visibilityOf(driver.findElement(By.xpath("//div[@class='errorValidationIn'" +
                " and text()='Please enter all your given first name(s)']"))));
        WebElement firstNameValidationMessage = driver.findElement(By.xpath("//div[@class='errorValidationIn' an" +
                "d text()='Please enter all your given first name(s)']"));
        WebElement lastNameValidationMessage = driver.findElement(By.xpath("//div[@class='errorValidationIn' and" +
                " text()='Please enter your last name in alphabetic characters']"));
        WebElement emailValidationMessage = driver.findElement(By.xpath("//div[@class='errorValidationIn' and te" +
                "xt()='Invalid email format.']"));
        WebElement phoneNumberValidationMessage = driver.findElement(By.xpath("//div[@class='errorValidationIn' " +
                "and text()='Invalid phone format.']"));
    ...
    @Description("Click on the Terms and Conditions link should redirect user to the Client Agreement page - each regulative separately")
    ...
    public void checkTermsAndConditionsLinkRedirection(String regulation, String tag) throws IOException, InterruptedException {
        ...
        driver.get("https://www.fortrade.com/minilps/en/reg-to-invest-in-stocks-only-work-with-the-best/" + tag + "");
        AccountRegistrationPage accountRegistrationPage = new AccountRegistrationPage(driver);
        WebDriverWait wdWait = new WebDriverWait(driver, 10);
