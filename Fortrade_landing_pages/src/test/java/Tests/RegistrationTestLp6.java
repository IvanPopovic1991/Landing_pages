...
public class RegistrationTestLp6 extends BaseTest {
    ...
    public void checkTermsAndConditionsLinkRedirection(String regulation, String tag) throws IOException, InterruptedException {
        ...
        driver.get("https://www.fortrade.com/minilps/en/when-you-jump-into-online-trading-be-smart-about-it/" + tag + "");
        AccountRegistrationFullNamePage accountRegistrationFullNamePage = new AccountRegistrationFullNamePage(driver);
        WebDriverWait wdWait = new WebDriverWait(driver, 10);
    ...
    public void checkRiskWarningLinkRedirection(String regulation, String tag) throws IOException {
        ...
        wdWait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//div[@id='formWrapper' and @class='" +
                "col-md-5 formCover formCoverFixed']//button[@onclick='myCloseFormFunction()']")));
        wdWait.until(ExpectedConditions.elementToBeClickable(By.xpath("//div[@id='formWrapper' and @class='col-md-5" +
                " formCover formCoverFixed']//button[@onclick='myCloseFormFunction()']")));
